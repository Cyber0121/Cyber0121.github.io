    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const prizes = [
                ...
                { name: "Cyber Phantom", type: "win", icon: "👕", class: "bronze" },
                { name: "2,000 UC", type: "win", icon: "💰", class: "silver" },
                { name: "Mythic Skin", type: "win", icon: "👕", class: "silver" },
                { name: "Special Vehicle", type: "win", icon: "🚗", class: "bronze" },
                { name: "Try Again", type: "lose", icon: "❌", class: "bronze" },
                { name: "Try Again", type: "lose", icon: "❌", class: "silver" },
                { name: "Try Again", type: "lose", icon: "❌", class: "bronze" },
                { name: "Try Again", type: "lose", icon: "❌", class: "gold" },
                { name: "Try Again", type: "lose", icon: "❌", class: "bronze" }
            ];
